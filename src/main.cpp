...
//https://os.mbed.com/users/fangoman91/code/WaveGen_v4//file/cb84b066ab29/WaveGen.cpp/
...
// Déclaration du générateur de signal
WaveGen waveGen;
...
void setup() {
  ...
  waveGen.setFrequency(100); // Fréquence de 100 Hz
  waveGen.setAmplitude(1.65); // Amplitude de 1.65V pour un signal de 0 à 3.3V
